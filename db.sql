...
ALTER TABLE programmer ADD COLUMN IF NOT EXISTS salary DECIMAL;

ALTER TABLE programmer DROP COLUMN IF EXISTS salary;

ALTER TABLE programmer ALTER COLUMN programming_language TYPE TEXT;

ALTER TABLE programmer RENAME TO developers;

ALTER TABLE developers RENAME COLUMN email TO login;
...
DELETE FROM developers WHERE name = 'John';
